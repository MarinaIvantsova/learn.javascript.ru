...
readDate.set(messages[0], new Date(2021, 5, 3));

console.log(readDate.has(messages[0]));

messages.shift();

console.log(readDate.has(messages[0]));// при удалении объекта из массива messages,
//он также удаляется из объекта weakMap
