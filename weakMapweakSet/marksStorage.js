...
console.log("Прочитано первое сообщение? " + readMessages.has(messages[0])); // true

messages.shift(); // удаляем из массива messages первый элемент и в структуре readMessages тоже он удаляетя,
// но технически может и позже
